...
This package provides page-chrome and navigation-structure standards for MarinOS web apps and documentation: what belongs in a header, how breadcrumbs work, and how the shared MarinOS identity mark is used in the banner and favicon.

## Files

- `SKILL.md` — header contents, breadcrumb pattern, and MarinOS icon usage
